  ...
  return (
    <main className="bg-white">
      ...
      <section className="px-6 py-20 md:px-12 lg:px-24">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.85fr_1.35fr]">
          {/* Info */}
          <div>
            <h2
              className="mb-10 text-4xl font-semibold leading-tight tracking-[-0.04em] text-slate-950 md:text-5xl"
              style={{
                fontFamily: "'Poppins', sans-serif",
                fontWeight: 500,
            ...
            <div
              className="space-y-5 text-lg text-slate-700"
              style={{
                fontFamily: "'Inter', sans-serif",
              }}
            >
              <div className="flex items-center gap-4">
                <Mail className="text-blue-900" size={26} />
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="mailto:support@aides-t2d.org"
                  className="transition hover:text-blue-900"
                >
                  support@aides-t2d.org
                </a>
              </div>
              ...
              <div className="flex items-center gap-4">
                <Globe className="text-blue-900" size={26} />
          ...
          <form className="grid gap-5">
            <div className="grid gap-5 md:grid-cols-2">
              <input
                ...
                className="h-14 border border-slate-200 bg-slate-50 px-5 text-base outline-none transition focus:border-blue-900 focus:bg-white"
              />
            ...
            <textarea
              ...
              rows={6}
              className="resize-none border border-slate-200 bg-slate-50 px-5 py-4 text-base outline-none transition focus:border-blue-900 focus:bg-white"
            />

            <button
              type="submit"
              className="h-14 bg-blue-900 text-base font-semibold text-white transition hover:bg-blue-950"
              style={{
                fontFamily: "'Inter', sans-serif",
                letterSpacing: "-0.01em",
              }}
